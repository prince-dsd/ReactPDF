...
import { PageDown, PageUp, SearchIcon, Thumbnail, ZoomIn, ZoomOut, DownloadIcon } from '../../assets';
...
class Toolbox extends Component {
  ...
  render() {
    ...
    const { toggleThumbnail, currentPage, onZoomIn, onZoomOut, showSearchBar, onChangePage, onDownload, mobileDevice } =
      this.props;
      ...
      <div className='toolbox-container'>
        <div className='toolbox-wrapper'>
          <div className='toolbox'>
            {!mobileDevice && <Thumbnail id='thumbnail-icon' onClick={toggleThumbnail} />}

            <div className='page-navigation'>
              <PageUp id='page-up' onClick={this.pageUp} className={`page-up ${currentPage === 1 ? 'disabled' : ''}`} />
            ...
            <DownloadIcon id='download-icon' onClick={onDownload} />
          </div>
        </div>
      </div>
    );
